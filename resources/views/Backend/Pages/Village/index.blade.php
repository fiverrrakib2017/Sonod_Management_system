...
<section class="content-header">
    <button type="button" data-id="1" class="btn-success modal-info btn bg-primary btn-flat" data-toggle="modal" data-target="#addModal"><i class="fa fa-pencil"></i>নতুন গ্রাম যুক্ত করুন</button>
</section>         
    ...
    <div class="row">
        ...
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">নতুন গ্রাম যুক্ত করুন
      ...
      <div class="modal fade" id="editModal">
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">গ্রাম আপডেট করুন
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button></h4>
            </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    var table = $('#datatable1').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.village.all_data') }}",
            type: 'GET',
            data: function(d) {
        ...
        columns: [
            ...
            { data: 'village_name_bn' },
            { data: 'village_name_en' },
  ...
  $(document).on('change','#search_upzila_id',function(){
    var Id = $(this).val();
    var _prev_url = '{{ route("admin.union.get_union", ":id") }}';
    var url = _prev_url.replace(':id', Id);
    if (Id) {
        $.ajax({
            url: url,
            ...
            dataType: 'json',
            success: function (data) {
                $('#search_union_id').empty();
                $('#search_union_id').append('<option>---নির্বাচন করুন---</option>');
                $.each(data, function (key, value) {
                    $('#search_union_id').append('<option value="' + value.id + '">' + value.union_name_bn + '</option>');
                });
            }
        });
    } else {
